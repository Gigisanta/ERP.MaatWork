...
import { inheritAdvisorFromExisting, shouldFlagConflict, type ExistingAumAccountSnapshot } from './aumConflictResolution';
...
describe('AUM Conflict Resolution Helpers', () => {
  describe('inheritAdvisorFromExisting', () => {
    ...
    it('returns null when no advisor information exists anywhere', () => {
      const advisor = inheritAdvisorFromExisting(
        undefined,
        [
