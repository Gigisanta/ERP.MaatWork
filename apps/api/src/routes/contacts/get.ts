...
import { db, contacts, contactTags, tags, tasks, attachments, pipelineStages, users, brokerAccounts, notes, clientPortfolioAssignments } from '@cactus/db';
...
router.get('/:id/detail', 
  ...
  try {
    ...
    const { contact, tags: contactTagsData, tasks: contactTasks, notes: contactNotes, brokerAccounts: contactBrokerAccounts, portfolioAssignments: contactPortfolioAssignments } = contactDetail;
