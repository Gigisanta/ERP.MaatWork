 ...
 */
router.post('/daily', requireAuth, requireRole(['admin']), async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/weekly', requireAuth, requireRole(['admin']), async (req: Request, res: Response) => {
  try {
