...
async function testExcelLoading() {
  ...
  try {
    ...
    if (require('fs').existsSync(madrePath)) {
      ...
      console.log('❌ Archivo madre no encontrado en:', madrePath);
    }
    ...
    if (require('fs').existsSync(mensualPath)) {
      ...
      console.log('❌ Archivo mensual no encontrado en:', mensualPath);
    }
    ...
    if (require('fs').existsSync(comisionesPath)) {
      ...
      console.log('❌ Archivo de comisiones no encontrado en:', comisionesPath);
    }
    ...
    try {
      ...
      const tablesResult = await dbInstance.execute(sql`
        SELECT table_name 
      ...
      if (Array.isArray(tablesResult)) {
        ...
        console.log('  Resultado:', tablesResult);
      }
