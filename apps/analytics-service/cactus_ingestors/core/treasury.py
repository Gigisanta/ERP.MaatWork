...
def fetch_treasury_yields(
    date: Optional[str] = None, fields: Optional[List[str]] = None
) -> List[Dict[str, Any]]:
    """
    ...
    params = {"format": "json", "page[size]": 1000}
...
def fetch_treasury_rates(date: Optional[str] = None) -> Dict[str, Any]:
    """
