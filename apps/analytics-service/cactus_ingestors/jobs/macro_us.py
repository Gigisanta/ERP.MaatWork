...
FRED_SERIES = [
    ...
    {'id': 'PCEPI', 'name': 'Personal Consumption Expenditures Price Index', 'category': 'inflation'},
    ...
    try:
        ...
        for series_info in FRED_SERIES:
            try:
                ...
                if not series_data or 'seriess' not in series_data or len(series_data['seriess']) == 0:
                ...
                # TODO: Implement macro_series upsert logic
                ...
                # TODO: Save to DB using store.save_macro_points
        ...
        try:
            ...
            # TODO: Save to DB using store.save_yields
