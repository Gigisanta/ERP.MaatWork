...
class TimescaleStore:
    ...
    def save_macro_points(self, series_id: str, points: List[Dict[str, Any]]) -> int:
        """
    ...
    def save_yields(self, yields: List[Dict[str, Any]]) -> int:
        """
    ...
    def save_prices_daily(self, asset_id: str, prices: List[Dict[str, Any]]) -> int:
        """
        ...
        try:
            with conn.cursor() as cur:
                ...
                for event in events:
                    ...
                    text_vector = (
                        f"to_tsvector('spanish', %s)"
                        if event.get("country") == "AR"
                        else f"to_tsvector('english', %s)"
                    )
