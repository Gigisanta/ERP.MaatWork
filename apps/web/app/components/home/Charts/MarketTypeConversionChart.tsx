 ...
 */
export function MarketTypeConversionChart({ marketTypeConversion }: MarketTypeConversionChartProps) {
    ...
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={chartData} aria-label="Gráfico de conversión por tipo de mercado">
        ...
        <Tooltip
          ...
          formatter={(value: number, name: string, props: { payload?: { conversionRate?: number } }) => {
