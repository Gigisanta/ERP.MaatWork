 ...
 *
 * AI_DECISION: Componente reutilizable para login/register con Google
 * Justificación: DRY - mismo botón usado en login y register con diferentes contextos
 * Impacto: Código más mantenible, comportamiento consistente
 */
