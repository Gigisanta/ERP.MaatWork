        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className={`px-3 py-2 border rounded-md bg-gray-50 ${excedenteCalculado !== null && excedenteCalculado < 0 ? 'border-red-300 bg-red-50' : excedenteCalculado !== null && excedenteCalculado > 0 ? 'border-green-300 bg-green-50' : 'border-gray-200'}`}>
                <Text size="sm" className={excedenteCalculado !== null && excedenteCalculado < 0 ? 'text-red-700' : excedenteCalculado !== null && excedenteCalculado > 0 ? 'text-green-700' : 'text-gray-600'}>
                  {excedenteCalculado !== null ? formatCurrency(excedenteCalculado) : 'Sin especificar'}
                </Text>
              </div>
            </div>
          </div>
    ...
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <Text size="sm" weight="medium" color="secondary">Ingresos</Text>
          ...
          <div
            ...
            onClick={() => setIsEditing(true)}
          >
            <Text size="sm" weight="medium" color="secondary">Gastos</Text>
