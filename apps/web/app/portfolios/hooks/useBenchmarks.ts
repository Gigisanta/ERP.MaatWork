...
import type { Benchmark, BenchmarkComponent } from '@/types';
...
export function useBenchmarks() {
  ...
  const { entities: benchmarks, isLoading, error, refetch, createEntity: createBenchmark, updateEntity: updateBenchmark, deleteEntity: deleteBenchmark } = useEntityWithComponents<Benchmark & { components?: BenchmarkComponent[] }, BenchmarkComponent>({
