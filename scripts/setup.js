...
async function main() {
  ...
  if (!migrationResult.success) {
    ...
    console.log(error('   Verifica que PostgreSQL esté corriendo y que DATABASE_URL sea correcta\n'));
    process.exit(1);
  }
