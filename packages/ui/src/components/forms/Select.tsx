  ...
  (
    ...
    return (
      <div className="space-y-1.5">
        {label && (
          <label htmlFor={selectId} className="block text-sm font-medium text-text font-body">
            {label}
            {required && (
        ...
        >
          <SelectPrimitive.Trigger
            ...
            className={cn(
              ...
              'border rounded-md',
              'text-sm',
              // Focus styles - using Primary Purple
                ...
                {validItems.map((item) => (
                  <SelectPrimitive.Item
                    ...
                    className={cn(
                      ...
                      'hover:bg-primary-subtle hover:text-primary focus:bg-primary-subtle focus:text-primary',
