...
describe('ErrorState', () => {
  describe('Basic Rendering', () => {
    ...
    it('should render with action text', () => {
      render(<ErrorState title="Error" actionText="Try again later" />);
  ...
  describe('Retry Button', () => {
    ...
    it('should use custom retry text', () => {
      render(<ErrorState title="Error" onRetry={() => {}} retryText="Try again" />);
  ...
  describe('Request ID', () => {
    it('should not show request ID in production by default', () => {
      ...
      render(<ErrorState title="Error" requestId="abc123" />);
    ...
    it('should show request ID when showRequestId is true', () => {
      render(<ErrorState title="Error" requestId="abc123" showRequestId={true} />);
...
describe('InlineErrorState', () => {
  ...
  it('should render retry button when onRetry is provided', () => {
    const onRetry = vi.fn();
    render(<InlineErrorState message="Error" onRetry={onRetry} />);
  ...
  it('should show loading state when retrying', () => {
    render(<InlineErrorState message="Error" onRetry={() => {}} isRetrying={true} />);
