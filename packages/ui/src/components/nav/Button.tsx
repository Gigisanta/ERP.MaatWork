    ...
    <button 
      ...
      className={cn(
        ...
        // Variant styles with enhanced micro-interactions
        {
          ...
          'bg-primary text-text-inverse shadow-[0_4px_14px_0_rgba(89,0,255,0.25)] hover:bg-primary-hover hover:shadow-[0_6px_24px_0_rgba(89,0,255,0.45)] hover:-translate-y-0.5 focus:ring-primary':
            variant === 'primary',
          ...
          'bg-accent text-secondary hover:bg-accent-hover hover:shadow-[0_6px_20px_0_rgba(0,230,118,0.35)] hover:-translate-y-0.5 focus:ring-accent':
            variant === 'accent',
          ...
          'bg-error text-text-inverse hover:bg-error-hover hover:shadow-[0_6px_20px_0_rgba(239,68,68,0.35)] hover:-translate-y-0.5 focus:ring-error':
            variant === 'destructive',
        },
        // Size styles
        {
