...
- generic [active] [ref=e1]:
  ...
  - main [ref=e126]:
    - generic [ref=e133]:
      - generic [ref=e134]: ⚠️
      - heading "Error en AUM Rows" [level=2] [ref=e135]
      - paragraph [ref=e136]: Too many re-renders. React limits the number of renders to prevent an infinite loop.
      - group [ref=e137]:
        - generic "Detalles técnicos (development only)" [ref=e138] [cursor=pointer]
      - generic [ref=e139]:
        - button "🔄 Reintentar" [ref=e140] [cursor=pointer]
        - button "← Volver al hub" [ref=e141] [cursor=pointer]
