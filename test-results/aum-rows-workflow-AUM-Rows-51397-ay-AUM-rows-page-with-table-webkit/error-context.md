...
- generic [active] [ref=e1]:
  ...
  - main [ref=e124]:
    - generic [ref=e131]:
      - generic [ref=e132]: ⚠️
      - heading "Error en AUM Rows" [level=2] [ref=e133]
      - paragraph [ref=e134]: Too many re-renders. React limits the number of renders to prevent an infinite loop.
      - group [ref=e135]:
        - generic "Detalles técnicos (development only)" [ref=e136] [cursor=pointer]
      - generic [ref=e137]:
        - button "🔄 Reintentar" [ref=e138] [cursor=pointer]
        - button "← Volver al hub" [ref=e139] [cursor=pointer]
