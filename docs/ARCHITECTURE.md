...
- **Apps:**
  - API: `apps/api` (Express 4.18.2 + TypeScript + Pino + Helmet + CORS)
...
- Express 4.18.2, middlewares en orden: CORS → compression → requestId → helmet → pino-http → routes → error/404
